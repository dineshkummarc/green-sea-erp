        ...
        <div class="pageFormContent" layoutH="60">
           ...
           <div class="unit">
            ...
            <div class="unit" >
				...
				<span style="float:left;line-height:20px;"> -&nbsp;省&nbsp;</span>
				...
				<span style="float:left;line-height:20px;"> -市&nbsp;</span>
				...
				<span style="float:left;line-height:20px;"> -&nbsp;地区&nbsp;</span>
            </div>

	        <div class="unit">
	            <label>详细地址:</label>
	            <textarea name="Form[street]" class="required" style="width: 270px; height: 40px;" ><?php  echo!empty($receiver->	street)?$receiver->	street:null   ?></textarea>
