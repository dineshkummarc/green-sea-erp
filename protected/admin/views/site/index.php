...
<head>
	...
	<!-- <link href="uploadify/css/uploadify.css" rel="stylesheet" type="text/css" /> 更换编辑器--删除旧的编辑器样式表 -->
	<!-- 引用新的编辑器CSS -->
	...
	<!-- <script src="xheditor/xheditor-1.1.9-zh-cn.min.js" type="text/javascript"></script>删除旧版编辑器JS -->
	<!-- 引用新的编辑器JS -->
