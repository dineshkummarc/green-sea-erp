...
<form id="orderform" method="post" action="" enctype="multipart/form-data" onsubmit="return orderValidator()">
    ...
    <div class="prompt">
        ...
        <div style="display: none;">
            <div id="addExampleHtml" style="text-align: left;">
                <div style="font-weight: bold; padding: 15px 0;">我知道图片的网络地址（二选一，都选的情况下默认为填写的地址）：</div>
                <div style="text-indent: 2em;">
                    填写您的图片地址：<input type="text" name="Form[example_img]" class="text" />
                </div>
                <div style="font-weight: bold; padding: 15px 0;">我需要上传一张图片：</div>
                <div style="text-indent: 2em;">
                    选择您要上传的图片：<input type="file" name="example_img" />
                </div>
                <div style="text-align: center; padding: 15px 0;"><a class="button" style="margin-left: 160px;"><span>确定</span></a></div>
            </div>
        </div>
    ...
    <table class="neworder">
        <tr>
            ...
            <td>宽：<input type="text" name="Form[retouch_demand][width]" value="<?php echo isset($order->retouchDemandData['width']) ? $order->retouchDemandData['width'] : ''; ?>" class="input" style="width: 50px;" tip="750" />px&nbsp;&nbsp;&nbsp;&nbsp;[高：自适应]</td>
        </tr>
        <tr>
            <td width="100">需要正方形主图：</td>
            <td>
                <input type="checkbox" name="Form[retouch_demand][square]" value="1"
                    <?php echo isset($order->retouchDemandData['square']) ? 'checked' : ''; ?>  />
                <div class="info" style="padding-left: 0; padding-top: 5px;">正方形主图主要用于淘宝商品主图，绿浪视觉为您提供有偿方形主图编辑服务，选择此项每张加收2元。</div>
            </td>
        </tr>
        <tr>
            <td width="100">是否需要原图： </td>
            <td>
                <input type="checkbox" name="Form[retouch_demand][artwork]" value="1"
                    <?php echo isset($order->retouchDemandData['artwork']) ? 'checked' : ''; ?> />
        ...
        <tr>
            ...
            <td><input type="text" name="Form[retouch_demand][other]" value="<?php echo isset($order->retouchDemandData['other']) ? $order->retouchDemandData['other'] : ''; ?>"  class="input" tip="绿浪修图" /></td>
        </tr>
    </table>
    ...
    <table class="neworder">
        <tr>
            ...
            <td><input type="checkbox" name="Form[following]" value="1" <?php echo $order->following ? 'checked' : '' ?> /></td>
        </tr>
    </table>
